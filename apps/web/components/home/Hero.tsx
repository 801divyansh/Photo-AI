                    ...
                    >
                        ...
                        >   
                            ...
                            <div className="relative text-center max-w-3xl mx-auto space-y-8">
                                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 dark:from-purple-400 dark:via-pink-500 dark:to-red-500 bg-clip-text text-transparent">
                                    Start Your AI Portrait Journey Today
                                </h1>
                                <p className="text-muted-foreground text-xl">
                                    Join thousands of users who have already transformed their photos with our AI technology
                                </p>
