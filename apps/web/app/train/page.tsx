        ...
        <div className="flex flex-col items-center justify-center pt-4">
            <Card className="w-[600px] p-4">
                    ...
                    <div className="grid w-full items-center gap-4">
                        <div className="flex gap-3">
                            ...
                            <div className="flex flex-col space-y-1.5 flex-1">
                                ...
                                <Input id="name" placeholder="Age of the model" onChange={(e) => {setAge(e.target.value)}}/>
                            </div>
                        </div>
                        <div className="flex gap-3">
                            <div className="flex flex-col space-y-1.5 flex-1">
                        ...
                        <UploadModel onUploadDone={(zipUrl) => {
                            setZipUrl(zipUrl);
                        }}/>
                    </div>  
                </CardContent>
                <CardFooter className="flex justify-between">
                    ...
                    <Button disabled={!name || !zipUrl || !type || !age || !ethinicity || !eyeColor } onClick={trainModel}>Create Model</Button>
                </CardFooter>
            </Card>
        </div>
    )
